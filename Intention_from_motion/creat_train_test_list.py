...
root = '/home/linzhank/datasets/Intention_from_motion/IFM_resize/2D'
...
for item in list1:
    ...
    if int(p_new) < 3:
        if p_new != p:
            ...
            counter = 1
        if counter < 16:
            train1.append(class_list[0] + '/' + item)
            counter +=1
            # print('train:',item, counter-1)
        else:
            test1.append(class_list[0] + '/' + item)
            counter +=1
...
for item in list2:
    ...
    if int(p_new) < 8:
        ...
        if int(p_new) == 1:
            if counter < 14:
                train2.append(class_list[1] + '/' + item)
                counter +=1
                # print('train:',item, counter-1)
            else:
                test2.append(class_list[1] + '/' + item)
                counter +=1
                # print('test:',item, counter-1)
...
for item in list3:
    ...
    if int(p_new) < 12:
        if p_new != p:
            ...
            counter = 1
        if counter < 15:
            train3.append(class_list[2] + '/' + item)
            counter +=1
            # print('train:',item, counter-1)
        else:
            test3.append(class_list[2] + '/' + item)
            counter +=1
            # print('test:',item, counter-1)
...
for item in list4:
    ...
    if int(p_new) < 3:
        if p_new != p:
            ...
            counter = 1
        if counter < 13:
            train4.append(class_list[3] + '/' + item)
            counter +=1
            # print('train:',item, counter-1)
        else:
            test4.append(class_list[3] + '/' + item)
            counter +=1
            # print('test:',item, counter-1)
